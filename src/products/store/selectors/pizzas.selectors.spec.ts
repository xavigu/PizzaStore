...
describe('Pizzas Selectors', () => {
  ...
  describe('getSelectedPizza', () => {
    it('should return selected pizza as an entity', () => {
      ...
      // subscribe to get the params id of the pizza
      store
      ...
      // subscribe to get the whole pizza object selected
      store
  ...
  describe('getPizzaVisualised', () => {
    it('should return selected pizza composed with selected toppings', () => {
      ...
      store.dispatch(new fromActions.LoadPizzasSucess(pizzas));
      store.dispatch(new fromActions.LoadToppingsSucess(toppings));
      ...
      store
        .select(fromSelectors.getPizzaVisualize)
        .subscribe((selectedPizza) => (result = selectedPizza));
  ...
  describe('getPizzasLoaded', () => {
    it('should return the pizzas loaded state', () => {
      ...
      store.dispatch(new fromActions.LoadPizzasSucess([]));
